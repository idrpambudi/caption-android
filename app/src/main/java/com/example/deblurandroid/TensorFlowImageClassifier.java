...
public class TensorFlowImageClassifier implements Classifier{
  ...
  private static final int FEATURE_DIM = 1280;
  private static final String INPUT_NAME = "input_3" ;
  private static final String OUTPUT_NAME = "global_average_pooling2d_1/Mean";
  private static final String MODEL_FILE_NAME = "caption_encoder.pb";
